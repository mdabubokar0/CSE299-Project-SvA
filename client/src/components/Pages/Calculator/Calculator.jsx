...
export const Calculator = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="bg-[#F9F5E9] min-h-screen p-4 text-gray-100 flex flex-col items-center">
        <div className="bg-[#F7F7FA] text-black text-center py-4 rounded-xl text-2xl font-bold w-full max-w-4xl">
          Budget Calculator
        </div>
